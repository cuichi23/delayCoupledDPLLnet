...
def plotTimeSeries(phi, F, Fc, dt, orderparam, k, delay, F_Omeg, K, coupFct, Tsim, Fsim=None, show_plot=True):
	...
	plt.grid()
	plt.savefig('results/powerdensity_dB_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/powerdensity_dB_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	plt.savefig('results/freq_histo_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/freq_histo_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	if ( len(phi[0, :])>100 ):
		...
		plt.ylabel(r'histogram', fontdict = labelfont)
		plt.savefig('results/phase_histo_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
		plt.savefig('results/phase_histo_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	plt.savefig('results/phases-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/phases-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	print(r'frequency of zeroth osci at the beginning and end of the simulation:, freqStart=%.4f, freqEnd=%.4f  [rad/Hz]' %( (phi[int(2*1.0/(F*dt))][0]-phi[1][0])/(2*1.0/F-dt), (phi[-4][0]-phi[-4-int(2*1.0/(F*dt))][0])/(2*1.0/F-dt) ) )
	...
	plt.savefig('results/freq-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/freq-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	plt.savefig('results/orderP-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/orderP-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
...
def doEvalBruteForce(Fc, F_Omeg, K, N, k, delay, twistdelta, results, allPoints, initPhiPrime0, paramDiscretization, delays_0, show_plot=True):
	...
	plt.savefig('results/rot_red_PhSpac_meanR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/rot_red_PhSpac_meanR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	if N==3:
		plt.plot(alltwistPR[:,1],alltwistPR[:,2], 'yo', ms=8)
	plt.savefig('results/rot_red_PhSpac_lastR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/rot_red_PhSpac_lastR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	if N==3:
		...
		plt.xlim([1.05*allPoints[:,0].min(), 1.05*allPoints[:,0].max()])
		plt.ylim([1.05*allPoints[:,1].min(), 1.05*allPoints[:,1].max()])
	plt.savefig('results/imsh_PhSpac_meanR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/imsh_PhSpac_meanR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
	...
	if N==3:
		...
		plt.xlim([1.05*allPoints[:,0].min(), 1.05*allPoints[:,0].max()])
		plt.ylim([1.05*allPoints[:,1].min(), 1.05*allPoints[:,1].max()])
	plt.savefig('results/imsh_PhSpac_lastR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day))
	plt.savefig('results/imsh_PhSpac_lastR_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, now.year, now.month, now.day), dpi=300)
...
def doEvalManyNoisy(F, Fc, F_Omeg, K, N, k, delay, c, domega, twistdelta, results, allPoints, dt, orderparam, r, phi, omega_0, K_0, delays_0, show_plot=True):
	orderparam = np.array(orderparam)
	r          = np.array(r)

	if (delay == 0):
		t1 = int(round((2./F)/dt));	t2 = int(round((4./F)/dt));	t3 = int(round((6./F)/dt)); t4 = int(round((8./F)/dt));
	...
	# np.savez('results/freqs_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.npz' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), firstfreqsext=np.array(firstfreqsext), firstfreq=np.array(firstfreq), lastfreq=np.array(lastfreq) )
	...
	if np.std(delays_0.flatten()) > 1E-12:
		...
		plt.savefig('results/hist_transdelays_static_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
		plt.savefig('results/hist_transdelays_static_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	if np.std(K_0.flatten()) > 1E-12:
		...
		plt.savefig('results/hist_distCoupStr_static_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
		plt.savefig('results/hist_distCoupStr_static_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	if np.std(omega_0.flatten()) > 1E-12:
		...
		plt.savefig('results/omega0_intfreq_histo_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
		plt.savefig('results/omega0_intfreq_histo_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/hist_orderparam_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/hist_orderparam_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/histo_phases_t0_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/histo_phases_t0_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	if (delay == 0):
		...
		t1 = int(round((2./F)/dt)); label1 = 't=2*Tomega'
		t2 = int(round((4./F)/dt)); label2 = 't=4*Tomega'
		t3 = int(round((6./F)/dt)); label3 = 't=6*Tomega'
		t4 = int(round((8./F)/dt)); label4 = 't=8*Tomega'
	...
	plt.savefig('results/histo_phases_all_osci_diff_times_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/histo_phases_all_osci_diff_times_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/histo_lastfreq_all_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/histo_lastfreq_all_TSim_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.clf()
	if (delay==0):
		common_bins = np.linspace(	min( np.array([firstfreqsext[:,int(round((.1/F)/dt)),:].flatten(), lastfreq[:,:,:].flatten()]).flatten() ),
							  	max( np.array([firstfreqsext[:,int(round((.1/F)/dt)),:].flatten(), lastfreq[:,:,:].flatten()]).flatten() ),
								num=histo_bins )
		plt.hist(firstfreqsext[:,int(round((.1/F)/dt)),:].flatten(), bins=common_bins,
	...
	plt.legend()
	plt.title(r't=$0.1$: mean frequency $\bar{f}=%.3f$ and std $\sigma_f=%.5f$  [Hz]' %( np.mean(firstfreqsext[:,int(round((delay+.1*(1/F))/dt)),:].flatten()/(2.0*np.pi)),
																						 np.mean(np.std(firstfreqsext[:,int(round((delay+.1*(1/F))/dt)),:], axis=1), axis=0)/(2.0*np.pi) ) )
	plt.xlabel(r'frequency bins [rad/s]')
	plt.ylabel(r'loghist[$\dot{\phi}$]')
	plt.savefig('results/histoFreqAllOsci_2timePoints_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.month, now.day))
	plt.savefig('results/histoFreqAllOsci_2timePoints_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.month, now.day), dpi=dpi_value)
	...
	plt.xlabel(r'frequency bins [rad/s]')
	plt.ylabel(r'$loghist[\dot{\phi}]$')
	plt.savefig('results/histo_freq_all_osci_diff_times_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/histo_freq_all_osci_diff_times_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/orderParams-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/orderParams-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/mean_of_phase_vs_t_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/mean_of_phase_vs_t_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.savefig('results/mean_of_freq_vs_t_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/mean_of_freq_vs_t_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.xlabel(r'$t$ $[s]$', fontdict=labelfont)
	plt.ylabel(r'$\phi(t)$', fontdict=labelfont)
	plt.savefig('results/phases-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/phases-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
	...
	plt.xlabel(r't [s]', fontdict = labelfont)
	plt.ylabel(r'$\dot{\phi}(t)$ $[rad Hz]$', fontdict=labelfont)
	plt.savefig('results/freq-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.pdf' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day))
	plt.savefig('results/freq-vs-time_K%.2f_Fc%.2f_FOm%.2f_tau%.4f_c%.7e_%d_%d_%d.png' %(K, Fc, F_Omeg, delay, c, now.year, now.month, now.day), dpi=dpi_value)
